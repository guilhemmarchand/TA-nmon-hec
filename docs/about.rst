##########################################################################
About the TA-nmon-hec, technical addon for Nmon Performance app for Splunk
##########################################################################

* Author: Guilhem Marchand

* First release published in August 2017

* Purposes:

The TA-nmon-hec for the Nmon Performance application for Splunk implements the excellent and powerful nmon binary known as Nigel's performance monitor.
...
**The TA-nmon-hec is compatible with any version of Splunk Enterprise 6.x and Splunk Universal Forwarder 6.x.**
